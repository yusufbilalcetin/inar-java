...
public class TriangleWithException extends SimpleGeometricObject {
    ...
    public TriangleWithException(double side1, double side2, double side3) throws IllegalTriangleException {
        if (side1 + side2 <= side3 || side2 + side3 <= side1 || side1 + side3 <= side2) {
            throw new IllegalTriangleException("The sum of any\n two sides be greater than the remaining side");
        }
        this.side1 = side1;
        this.side2 = side2;
        this.side3 = side3;
